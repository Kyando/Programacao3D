...
public class TDETerrenoPerlinNoise implements Scene {
    ...
    public void init() {
        ...
        perlinNoise = new PerlinNoise(100, 100, 0);
        terreno = new Terreno(perlinNoise.getNoise(), perlinNoise.getWidth(), perlinNoise.getHeight(), 1.0f);
...
public void draw() {
    ...
    public static void main(String[] args) {
        new Window(new TDETerrenoPerlinNoise(), "Terreno", 800, 600).show();
    }
}
