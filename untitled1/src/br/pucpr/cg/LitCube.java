...
public void draw() {
    ...
    shader.bind()
        ...
        .setUniform("uLightPos", new Vector3f(1.0f, -1.0f, 1.05f))
        .setUniform("uDiffuseLight", new Vector3f(1.0f, 1.0f, 0.8f))
        .setUniform("uAmbientLight", new Vector3f(0.05f, 0.05f, 0.05f))
        .setUniform("uSpecularLight", new Vector3f(1.0f, -1.0f, 1.05f))
        .setUniform("uDiffuseMaterial", new Vector3f(0.8f, 0.0f, 0.8f))
        .setUniform("uAmbientMaterial", new Vector3f(0.8f, 0.0f, 0.8f))
